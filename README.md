...
ErrorMessage.jsx: A reusable component for displaying error messages.
...
## Assumptions
The JSON schema (formData.json) serves as the single source of truth for the form structure, making it easy to add or modify fields without changing the component code.
Validation logic is currently limited to checking required fields, but it can be extended as needed.